...
public class BF_Placeholder_View: UIView {
	...
	public lazy var imageView:BF_ImageView = {
	...
	convenience init(_ style:Style? = nil, _ error:Error? = nil, _ handler:BF_Button.Handler = nil) {
	...
	@discardableResult public func addLabel(_ string:String) -> BF_Label {
	...
	@discardableResult public func addButton(_ string:String? = nil, _ handler:BF_Button.Handler = nil) -> BF_Button {
		
		let button:BF_Button = .init(string,handler)
