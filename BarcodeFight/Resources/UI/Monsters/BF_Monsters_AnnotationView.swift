//
//  BF_Monsters_AnnotationView.swift
//  BarcodeFight
//
...
public class BF_Monsters_AnnotationView : MKAnnotationView {
	...
	public override var annotation: MKAnnotation? {
		...
		didSet {
			...
			monster = (annotation as? BF_Monsters_PointAnnotation)?.monster
		}
	}
	...
	private lazy var monsterStackView:BF_Monsters_Min_StackView = {
